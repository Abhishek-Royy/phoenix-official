...
const Footer = () => {
  return (
    <>
      <div className=" dark:bg-[#111C29] bg-gray-200 dark:text-white text-black shadow-slate-50 shadow-lg pt-10">
        <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
          ...
          <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
            <p className="text-[14px] font-normal dark:text-white md:text-[14px]">
              © Copyright 2024 • All rights Reserved •
              <a href="https://github.com/PhoenixTechCo" target="_blank">
                {" "}
                Phoenix Co.
              </a>
            </p>
